...
mixin _$TransactionEntity {
 ...
 String get id; String get fundId; String get fundName; double get amount; TransactionType get type; NotificationMethod get notificationMethod; DateTime get createdAt;
...
@override
int get hashCode => Object.hash(runtimeType,id,fundId,fundName,amount,type,notificationMethod,createdAt);

@override
String toString() {
  return 'TransactionEntity(id: $id, fundId: $fundId, fundName: $fundName, amount: $amount, type: $type, notificationMethod: $notificationMethod, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 String id, String fundId, String fundName, double amount, TransactionType type, NotificationMethod notificationMethod, DateTime createdAt
});
...
/// Create a copy of TransactionEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? fundId = null,Object? fundName = null,Object? amount = null,Object? type = null,Object? notificationMethod = null,Object? createdAt = null,}) {
...
as TransactionType,notificationMethod: null == notificationMethod ? _self.notificationMethod : notificationMethod // ignore: cast_nullable_to_non_nullable
as NotificationMethod,createdAt: null == createdAt ? _self.createdAt : createdAt // ignore: cast_nullable_to_non_nullable
as DateTime,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String fundId,  String fundName,  double amount,  TransactionType type,  NotificationMethod notificationMethod,  DateTime createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TransactionEntity() when $default != null:
return $default(_that.id,_that.fundId,_that.fundName,_that.amount,_that.type,_that.notificationMethod,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String fundId,  String fundName,  double amount,  TransactionType type,  NotificationMethod notificationMethod,  DateTime createdAt)  $default,) {final _that = this;
switch (_that) {
case _TransactionEntity():
return $default(_that.id,_that.fundId,_that.fundName,_that.amount,_that.type,_that.notificationMethod,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String fundId,  String fundName,  double amount,  TransactionType type,  NotificationMethod notificationMethod,  DateTime createdAt)?  $default,) {final _that = this;
switch (_that) {
case _TransactionEntity() when $default != null:
return $default(_that.id,_that.fundId,_that.fundName,_that.amount,_that.type,_that.notificationMethod,_that.createdAt);case _:
  return null;
...
class _TransactionEntity extends TransactionEntity {
  const _TransactionEntity({required this.id, required this.fundId, required this.fundName, required this.amount, required this.type, required this.notificationMethod, required this.createdAt}): super._();
...
/// Create a copy of TransactionEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? fundId = null,Object? fundName = null,Object? amount = null,Object? type = null,Object? notificationMethod = null,Object? createdAt = null,}) {
